...
window.probhat = {
	keymaps: {'`': '\u200D','~': '\u007E','1': '\u09E7','2': '\u09E8','3': '\u09E9','4': '\u09EA','5': '\u09EB','6': '\u09EC','7': '\u09ED','8': '\u09EE','9': '\u09EF','0': '\u09E6','-': '\u002D','=': '\u003D','!': '\u0021','@': '\u0040','#': '\u0023','$': '\u09F3','%': '\u0025','^': '\u005E','&': '\u099E','*': '\u09CE','(': '\u0028',')': '\u0029','_': '\u005F','+': '\u002B','q': '\u09A6','Q': '\u09A7','w': '\u09C2','W': '\u098A','e': '\u09C0','E': '\u0988','r': '\u09B0','R': '\u09DC','t': '\u099F','T': '\u09A0','y': '\u098F','Y': '\u0990','u': '\u09C1','U': '\u0989','i': '\u09BF','I': '\u0987','o': '\u0993','O': '\u0994','p': '\u09AA','P': '\u09AB','[': '\u09C7','{': '\u09C8',']': '\u09CB','}': '\u09CC','\\': '\u200C','|': '\u0965','a': '\u09BE','A': '\u0985','s': '\u09B8','S': '\u09B7','d': '\u09A1','D': '\u09A2','f': '\u09A4','F': '\u09A5','g': '\u0997','G': '\u0998','h': '\u09B9','H': '\u0983','j': '\u099C','J': '\u099D','k': '\u0995','K': '\u0996','l': '\u09B2','L': '\u0982',';': '\u003B',':': '\u003A','z': '\u09DF','Z': '\u09AF','x': '\u09B6','X': '\u09DD','c': '\u099A','C': '\u099B','v': '\u0986','V': '\u098B','b': '\u09AC','B': '\u09AD','n': '\u09A8','N': '\u09A3','m': '\u09AE','M': '\u0999',',': '\u002C','<': '\u09C3','.': '\u0964','..': '\u0965','>': '\u0981','/': '\u09CD','?': '\u003F'},
	supportIntellisense: false
};

window.bijoy={
	"keymaps": {"0":"০","1":"১","2":"২","3":"৩","4":"৪","5":"৫","6":"৬","7":"৭","8":"৮","9":"৯",a:"ৃ",A:"র্",d:"ি",D:"ী",s:"ু",S:"ূ",f:"া",F:"অ",g:"্",G:"।",h:"ব",H:"ভ",j:"ক",J:"খ",k:"ত",K:"থ",l:"দ",L:"ধ",z:"্র",Z:"্য",x:"ও",X:"ৗ",c:"ে",C:"ৈ",v:"র",V:"ল",b:"ন",B:"ণ",n:"স",N:"ষ",m:"ম",M:"শ",q:"ঙ",Q:"ং",w:"য",W:"য়",e:"ড",E:"ঢ",r:"প",R:"ফ",t:"ট",T:"ঠ",y:"চ",Y:"ছ",u:"জ",U:"ঝ",i:"হ",I:"ঞ",o:"গ",O:"ঘ",p:"ড়",P:"ঢ়","&":"ঁ","$":"৳","`":"","~":"","\\":"ৎ","|":"ঃ"},
	supportIntellisense: false
};

window.phonetic = {
	keymaps: {'k': '\u0995','0': '\u09E6','1': '\u09E7','2': '\u09E8','3': '\u09E9','4': '\u09EA','5': '\u09EB','6': '\u09EC','7': '\u09ED','8': '\u09EE','9': '\u09EF','i': '\u09BF','I': '\u0987','ii': '\u09C0','II': '\u0988','e': '\u09C7','E': '\u098F','U': '\u0989','u': '\u09C1','uu': '\u09C2','UU': '\u098A','r': '\u09B0','WR': '\u098B','a': '\u09BE','A': '\u0986','ao': '\u0985','Ao': '\u0985','s': '\u09B8','t': '\u099F','K': '\u0996','kh': '\u0996','n': '\u09A8','N': '\u09A3','T': '\u09A4','Th': '\u09A5','d': '\u09A1','dh': '\u09A2','b': '\u09AC','bh': '\u09AD','v': '\u09AD','R': '\u09DC','Rh': '\u09DD','g': '\u0997','G': '\u0998','gh': '\u0998','h': '\u09B9','NG': '\u099E','j': '\u099C','J': '\u099D','jh': '\u099D','c': '\u099A','ch': '\u099B','C': '\u099B','th': '\u09A0','p': '\u09AA','f': '\u09AB','ph': '\u09AB','D': '\u09A6','Dh': '\u09A7','z': '\u09AF','y': '\u09DF','Ng': '\u0999','ng': '\u0982','l': '\u09B2','m': '\u09AE','sh': '\u09B6','S': '\u09B7','O': '\u0993','ou': '\u099C','OU': '\u0994','Ou': '\u0994','Oi': '\u0990','OI': '\u0990','tt': '\u09CE','H': '\u0983','.': '\u0964','..': '\u002E','HH': '\u09CD\u200C','NN': '\u0981','Y': '\u09CD\u09AF','w': '\u09CD\u09AC','W': '\u09C3','wr': '\u09C3','x': '\u0995\u09CD\u09B8','rY': '\u09B0\u200D\u09CD\u09AF','L': '\u09B2','Z': '\u09AF','P': '\u09AA','V': '\u09AD','B': '\u09AC','M': '\u09AE','X': '\u0995\u09CD\u09B8','F': '\u09AB',"+": '\u09CD',"++": "+","o":'\u09CB',"oI":'\u09C8',"oU":"\u09CC"},
...
tinymce.PluginManager.add('bangla-kb', function(editor, url) {
	editor.addButton('bangla-kb', {
		text: 'Select KB',
		type: 'menubutton',
		icon: false,
		menu: [
			...
			{
				text: 'Phonetic (ফোনেটিক)',
				onclick: enablePhonetic
			},
			{
				text: 'Probhat (প্রভাত)',
				onclick: enableProbhat
			},
			{
				text: 'Bijoy (বিজয়)',
				onclick: enableBijoy
	...
	return {
		getMetadata: function () {
			return  {
				name: "banglafkb",
				url: "https://github.com/bluedot-bd/bangla-kb"
			};
		}
	};
